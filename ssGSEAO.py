...
# df = df[["gene_name", "gene_type", "unstranded", "stranded_first", "stranded_second", "tpm_unstranded", "fpkm_unstranded", "fpkm_uq_unstranded"]]
# df = df[["gene_name", "tpm_unstranded"]]
df = df[["gene_name", "stranded_first"]]
...
print(results.res2d[results.res2d["Term"] == "HALLMARK_GLYCOLYSIS"]["NES"])
print(results.res2d[results.res2d["Term"] == "HALLMARK_OXIDATIVE_PHOSPHORYLATION"]["NES"])
# Extract scores
